...
public class Queen extends Piece{
    public Queen(int positionRow, int positionColumn, boolean isWhite, ImageIcon image) {
    ...
    public boolean validMove(int destRow, int destColumn, Piece[][] pieces) {
        ...
        // Verificar que el movimiento es vertical, horizontal o diagonal
        if (currentRow == destRow || currentColumn == destColumn ||
                Math.abs(destRow - currentRow) == Math.abs(destColumn - currentColumn)) {
